      ...
      <div className="row">
        <div className='col-md-4 '>
          <div className='position-relative'>
             {movieDetails.poster_path?<img src={`https://image.tmdb.org/t/p/w500/${movieDetails.poster_path}`} className='w-100' alt="movie" />
             :""}
             {movieDetails.profile_path?<img src={`https://image.tmdb.org/t/p/w500/${movieDetails.profile_path}`} className='w-100' alt="" />
             :""}
      ...
      <div className="row p-5 gy-4 gx-4 ">
        {SimilarMovies.map((movie, index) =>
          <div className="col-md-2" key={index}>
            <Link to={`/similarDetails/${movie.id}/${params.media_type}`}>
